/*
    ...
    by Stanley Ondrus & Victor Casado

    - XY - 2 dimensional laser scanning
    - Automatic mirror calibration
    - Remote serial control (via bluetooth) and USB
    - Auto mode
    - Remote control app with Windows and Android GUI
...
void setup()
{
  ...
  Serial.println("Developed by Stanley Ondrus & Victor Casado");
